...
{
    $result1 = mysqli_query($con,"update employee set E_name='$_POST[name]',E_email='$_POST[mail]',E_CNO='$_POST[cno]',Password='$_POST[Password]',E_Add='$_POST[address]' where E_post = 'Admin'");
    if(!$result1){
...
<div class="formcontainer">
    ...
    <form method="post">
        ...
        <div class="input__box">
            ...
            <input type="email"  name="mail" value="<?php echo $data['E_email'];?>">
        </div>
        <div class="input__box">
        ...
        <div class="input__box">
            ...
            <input type="text" name="sal" value="<?php echo $data['E_sal'];?>">
        </div>
        <div class="input__box">
            <span class="details">Designation</span>
            <input type="text" name="post" value="<?php echo $data['E_post'];?>" disabled>
        </div>
        <div class="input__box">
